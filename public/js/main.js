...
const I18N = {
  ...
  ar: {
    "meta-title": "تك إت LLC — نقود النظم الرقمية للجيل القادم",
    "meta-desc": "تك إت هي الشركة القابضة الداعمة لأبرز المنصات الإقليمية في التجارة الإلكترونية وتحسين الأعمال وبوابات المؤسسات.",
    "nav-about": "عن الشركة",
    ...
    "hero-paragraph": "تك إت هي الشركة المالكة التي تقف خلف أبرز المنصات الإقليمية في التجارة الإلكترونية وتحسين الأعمال وبوابات المؤسسات.",
    ...
    "about-p1": "تك إت هي شركة احتضان تقني وشركة ملتزمة بالموثوقية التشغيلية والنمو المستدام للمنصات. نبتكر ونموّل ونوسّع منتجات رقمية متخصصة تنقل قيمة حقيقية في المنطقة.",
    "about-p2": "من طلب القهوة أثناء التنقّل إلى حجز الفنادق بالساعات وبوابات المؤسسات الآمنة، تعمل كل شركة تابعة بتركيزها الخاص — مع مشاركة البنية التحتية والحوكمة والرؤية طويلة الأجل لمظلة تك إت.",
    "wfrlee-name": "Wfrlee.com",
    "wfrlee-tagline": "فنادق تُحجز بالساعات.",
    "wfrlee-desc": "احجز إقامات قصيرة بأسعار مرنة بالساعات. ادفع فقط مقابل الوقت الذي تستخدمه — دون الحاجة لدفع قيمة ليلة كاملة.",
    "wfrlee-c1": "حجز مرن بأسعار الساعات",
    "wfrlee-c2": "تسعير الدفع حسب الإقامة",
    "wfrlee-c3": "جدولة فورية للإقامات القصيرة",
    "wfrlee-visit": "زيارة wfrlee.com",
    "wfrlee-label": "حجز الفنادق بالساعات",
    ...
    "wfrlee-step2": `<span class="text-white font-semibold">احجز بالساعات</span> — ادفع لكل ساعة دون رسوم الليلة الكاملة.`,
    ...
    "contact-desc": "سواء كنت شريكًا، أو نشاطًا تجاريًا يستكشف منصاتنا، أو فريقًا يتطلع للنمو تحت مظلة تك إت — يسعدنا أن نسمع منك.",
    ...
    "footer-rights": `© <span id="year"></span> تك إت. جميع الحقوق محفوظة.`,
  },
};
